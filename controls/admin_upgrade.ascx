...
<am:Callback ID="cbUpgrade" runat="server">
	...
	<div id="upStep2" style="display:none;width:200px;margin-right:auto;margin-left:auto;text-align:center;font-weight:bold;">This may take several minutes.<br /><img src="<% (DotNetNuke.Modules.ActiveForums.Globals.ModuleImagesPath) %>spinner-lg.gif" runat="server" /></div>
	</Content>
