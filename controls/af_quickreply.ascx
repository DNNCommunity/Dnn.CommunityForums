...
<table class="afgrid">
	<tr>
		...
		<td class="afgrouprow" align="right" style="text-align:right;padding-right:10px;"><img align="absmiddle" class="afarrow" id="imgGroupQR" alt="toggle" onclick="toggleGroup('QR');" src="<%=ImagePath + "/arrows_down.png"%>" /></td>
	</tr>
	<tr>
