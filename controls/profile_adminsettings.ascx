...
<table width="100%" cellspacing="0" cellpadding="1" border="0">
			   ...
			   <div class="amtbwrapper" style="text-align:center;">
					...
					<am:imagebutton id="btnAdminSave" CssClass="amimagebutton" Height="50" Width="50" runat="server" PostBack="False" ClientSideScript="amaf_saveAdmin();" ImageLocation="TOP" text="[RESX:Button:Save]" ImageUrl="<% (DotNetNuke.Modules.ActiveForums.Globals.ModuleImagesPath) %>save32.png" />
					<am:ImageButton ID="btnAdminCancel"  CssClass="amimagebutton" Height="50" Width="50" runat="server" PostBack="false" ImageLocation="TOP" ClientSideScript="amaf_cancelAdmin();" Text="[RESX:Button:Cancel]" ImageUrl="<% (DotNetNuke.Modules.ActiveForums.Globals.ModuleImagesPath) %>cancel32.png" />
					</div>
				</div>
