				...
				<table cellpadding="4" cellspacing="0" border="0" class="afsubgrid">
					<tr>
						<td class="afgrouprow afgrouprow-f">
							<div class="afcontrolheader">[TRESX:FORUMHEADER]</div>
						</td>
						<td class="afgrouprow afgrouprow-m">
							<div class="afcontrolheader"><i class="fa fa-files-o fa-fw fa-grey"></i> [TRESX:TOPICSHEADER]</div>
						</td>
						<td class="afgrouprow afgrouprow-m">
							<div class="afcontrolheader"><i class="fa fa-reply fa-fw fa-grey"></i> [TRESX:REPLIESHEADER]</div>
						</td>
						<td class="afgrouprow afgrouprow-m">
								<div class="afcontrolheader"><i class="fa fa-envelope-o fa-fw fa-grey"></i>&nbsp;[RESX:SUBSCRIBERS]</div>
							</td>
							<td class="afgrouprow afgrouprow-l">
							<div class="afcontrolheader"><i class="fa fa-file-o fa-fw fa-grey"></i> [TRESX:LASTPOSTHEADER]</div>
						</td>
					</tr>
					[FORUMS]
										<tr>
							 ...
							 <table class="afgrid" cellspacing="0" cellpadding="0" width="100%">
								<tr>
									...
									<td class="aftopicrow af-content">
										<table>
											<tr>
												...
												<span class="afhiddenstats">[TOTALTOPICS] [TRESX:TOPICSHEADER] and [TOTALREPLIES] [TRESX:REPLIESHEADER] and [FORUMSUBSCRIBERCOUNT] [RESX:SUBSCRIBERS]</span>
												...
												<span class="aftopicsubtitle">[FORUMDESCRIPTION]</span><div class="af_lastpost_responsive" style="white-space:nowrap;">[LASTPOSTSUBJECT:25]<br />[TRESX:BY] [DISPLAYNAME]<br />[LASTPOSTDATE]</div>
									...
									<td class="aftopicrow af-colstats af-colstats-views">[FORUMSUBSCRIBERCOUNT]</td>
										<td class="aftopicrow af-lastpost"><div class="af_lastpost" style="white-space:nowrap;">[LASTPOSTSUBJECT:25]<br />[TRESX:BY] [DISPLAYNAME]<br />[LASTPOSTDATE]</div></td>
								</tr>
							</table>	
									</td>
								</tr>
		...
		<tr>
			<td colspan="2">
				 <table class="afgrid" cellspacing="0" cellpadding="4" width="100%">
					<tr>
						<td class="afgrouprow afgrouprow-f">
							<div class="afcontrolheader">[TRESX:Announcements]</div>
						</td>
						<td class="afgrouprow afgrouprow-m">
							<div class="afcontrolheader">[TRESX:REPLIES]</div>
						</td>
						<td class="afgrouprow afgrouprow-m">
							<div class="afcontrolheader">[TRESX:Views]</div>
						</td>
						<td class="afgrouprow afgrouprow-m">
								<div class="afcontrolheader">[RESX:SUBSCRIBERS]</div>
							</td>
							<td class="afgrouprow afgrouprow-l">
							<div class="afcontrolheader">[TRESX:LASTPOSTHEADER]</div>
						</td>
					</tr>
					[ANNOUNCEMENT]
					<tr>
						...
						<td class="[ROWCSS] af-colstats af-colstats-views">[TOPICSUBSCRIBERCOUNT]</td><td class="[ROWCSS] af-lastpost"><div class="af_lastpost" style="white-space:nowrap;">[LASTPOST][TRESX:BY] <i class="fa fa-user fa-fw fa-blue"></i> [LASTPOSTDISPLAYNAME][AF:ICONLINK:LASTREPLY]<br />[LASTPOSTDATE][/LASTPOST]</div></td>
					</tr>
					[/ANNOUNCEMENT]
				</table>	
						</td>
		...
		<tr>
			...
			<div id="afgrid" style="position:relative;">
				<table class="afgrid" cellspacing="0" cellpadding="4" width="100%">
						<tr>
							<td class="afgrouprow afgrouprow-f">
								<div class="afcontrolheader">[TRESX:TOPICSHEADER]</div>
							</td>
							<td class="afgrouprow afgrouprow-m">
								<div class="afcontrolheader"><i class="fa fa-reply fa-fw fa-grey"></i> [TRESX:REPLIESHEADER]</div>
							</td>
								<td class="afgrouprow afgrouprow-m">
								<div class="afcontrolheader"><i class="fa fa-eye fa-fw fa-grey"></i> [TRESX:Views]</div>
							</td>
							<td class="afgrouprow afgrouprow-m">
									<div class="afcontrolheader"><i class="fa fa-envelope-o fa-fw fa-grey"></i>&nbsp;[RESX:SUBSCRIBERS]</div>
								</td>
								<td class="afgrouprow afgrouprow-l">
								<div class="afcontrolheader"><i class="fa fa-file-o fa-fw fa-grey"></i> [TRESX:LastPost]</div>
							</td>
						</tr>
						[TOPICS]
						...
						<tr>
							<td class="[ROWCSS] af-content af-postcontent">
								<table width="100%">
									...
									<td  rowspan="2" style="padding-top:5px; padding-right:7px;" class="[ROWCSS] af-posticon">[POSTICON]</td>
										...
										<span class="afhiddenstats">[REPLIES] [TRESX:REPLIESHEADER] and [VIEWS] [TRESX:Views]</span>
										<span class="aftopictitle">[SUBJECTLINK][AF:ICONLINK:LASTREAD][ICONPIN][ICONLOCK]</span> <span class="af-colstats_responsive"><i class="fa fa-eye fa-fw fa-grey"></i> [VIEWS] <i class="fa fa-reply fa-fw fa-grey"></i> [REPLIES]<i class="fa fa-envelope-o fa-fw fa-grey"></i>&nbsp;[TOPICSUBSCRIBERCOUNT]</span>
										<span class="aftopicstarted">Started by <i class="fa fa-user fa-fw fa-blue"></i> [STARTEDBY][AF:UI:MINIPAGER]</span>
							...
							<td class="[ROWCSS] af-colstats af-colstats-views">[TOPICSUBSCRIBERCOUNT]</td>
								<td class="[ROWCSS] af-lastpost"><div>[LASTPOST][TRESX:BY] <i class="fa fa-user fa-fw fa-blue"></i> [LASTPOSTDISPLAYNAME][AF:ICONLINK:LASTREPLY]<br />[LASTPOSTDATE][/LASTPOST]</div></td>
						</tr>
						[/TOPICS]
				</table>
			</div>
