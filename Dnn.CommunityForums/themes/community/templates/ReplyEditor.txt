...
<div class="afeditor">
	<table cellpadding="10" cellspacing="0" width="100%">
		<tr>
			<td style="border-bottom:solid 1px #cdcdcd;text-align:left;"><span class="aftitle">[TRESX:ReplyToTopic]</span></td>
			<td style="border-bottom:solid 1px #cdcdcd;text-align:right;"><span style="font-weight:bold;">[TRESX:Topic]:</span> [AF:LINK:TOPICNAME]</td>
		</tr>
		<tr>
			<td colspan="2" align="center">			
				<table cellpadding="0" cellspacing="4" border="0" width="99%">
					[AF:UI:MESSAGEREPLY]
					<tr>
						<td style="text-align:left;">[TRESX:ReplyToMessage]:</td>
						<td></td>
					</tr>
					<tr>
					...
					[/AF:UI:ANON]
					<tr>
						<td style="text-align:left;">[TRESX:Subject]:</td>
						<td></td>
					</tr>
					<tr>
					...
					<tr>
						<td style="text-align:left;">[TRESX:Message]:</td>
						<td></td>
					</tr>
					<tr>
